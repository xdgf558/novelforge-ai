...
type CharacterHistoryPageProps = {
  params: Promise<{
    projectId: string;
    characterId: string;
  }>;
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <Link
            ...
            href={`/projects/${character.project.id}/characters/${character.id}`}
          >
          ...
          <div className="divide-y divide-ink-950/10">
            {character.versions.map((version) => (
              <Link
                ...
                href={`/projects/${character.project.id}/characters/${character.id}/history/${version.id}`}
                key={version.id}
              >
