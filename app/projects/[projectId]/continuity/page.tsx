    ...
    <div className="space-y-6">
      ...
      {totalCount === 0 ? (
        ...
        <section className="nf-review-workspace">
          ...
          <div className="nf-review-detail nf-continuity-review-detail">
            {selectedReport ? (
              (() => {
                ...
                return (
                  <article
                    ...
                    key={report.id}
                  >
                    <div className="nf-continuity-review-header">
                      <div className="nf-continuity-review-copy">
                      ...
                      {report.status === "open" ? (
                        <div className="nf-continuity-review-actions space-y-3">
                          {isStale ? (
                        ...
                        <form
                          ...
                          className="nf-continuity-review-actions"
                        >
                          <ContinuityReviewContextFields
                            page={page}
                            reportId={report.id}
                    ...
                    <div className="nf-continuity-review-evidence mt-5">
