...
- `npm run test -- components/preserve-scroll-form.test.ts lib/ai/wechat-layout-candidates.test.ts lib/wechat-layout-export.test.ts` passed, 3 files and 15 tests.
- `npm run test` passed, 56 files and 308 tests.
