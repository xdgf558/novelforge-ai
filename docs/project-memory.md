...
- Current source app version is `0.1.114`; the latest personal-use macOS
  installer is
  `release/desktop/NovelForge-AI-0.1.114-mac-arm64.pkg`. This release has a
  ...
  explicitly authorize a new Apple upload for this rebuild, so `0.1.114` is
  ...
  previous `0.1.113` artifact was removed at the author's request. Future
