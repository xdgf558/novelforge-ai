...
- Multi-storyline planning lives in `storylines` plus project-scoped relation tables for characters, foreshadows, chapters, and outlines. `/projects/[projectId]/storylines` is the manual author-controlled management surface for mainlines, subplots, character arcs, business lines, antagonist lines, foreshadow lines, world lines, and other narrative threads. Phase 29-style storyline data is formal planning memory: AI may read it in future phases, but must not auto-detect, auto-link, or auto-mutate storylines without explicit author review and adoption.
