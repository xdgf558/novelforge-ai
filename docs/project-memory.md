...
- Current formal personal-use macOS installer version is `0.1.8`; handoff should leave only `release/desktop/NovelForge-AI-0.1.8-mac-arm64.pkg` in the delivery folder unless the user explicitly asks for DMG/ZIP/update metadata.
